...
st.set_page_config(
    page_title="Text Translator and Speech Synthesizer",
    page_icon="🌐",
    layout="wide",
...
def synthesize_speech(text, lang_code):
    """
    Synthesizes speech from the input text in the specified language.
    ...
    if not text_to_translate:
        ...
        if translations:
            ...
            for lang, translation in translations.items():
                ...
                try:
                    audio_bytes = synthesize_speech(translation, lang)
